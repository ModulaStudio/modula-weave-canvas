        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4">
              <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-all h-full">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <motion.a href="https://instagram.com/modulastudio.ke" 
                      aria-label="Instagram" 
                      className="w-10 h-10 flex items-center justify-center bg-modula-light-grey text-modula-charcoal rounded-full hover:bg-modula-coral hover:text-white transition-all"
                      whileHover={{ scale: 1.1 }}
                    >
                      <Instagram size={18} />
                    </motion.a>
                    <motion.a href="https://x.com/ModulaStudio" 
                      aria-label="Twitter" 
                      className="w-10 h-10 flex items-center justify-center bg-modula-light-grey text-modula-charcoal rounded-full hover:bg-modula-coral hover:text-white transition-all"
                      whileHover={{ scale: 1.1 }}
                    >
